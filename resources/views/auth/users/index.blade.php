                ...
                <tbody>
                    @foreach ($users as $user)
                        <tr>
                            ...
                            <td><a href="{{ route('user.details',$user) }}">{{ $user->fullname }}</a></td>
                            <td>{{ $user->email }}</td>
                            ...
                            <td>
                                ...
                                <div class="btn-hover">
                                    ...
                                    <button record-id="{{ $user->id }}" href="{{ route('user.edit',$user) }}" class="btn btn-outline-danger" role="delete-btn"> <i class="fa fa-trash"></i> Delete</button>
                                </div>
                            </td>
                        </tr>
                    @endforeach
...
<form  method="POST" id="user-delete-form" role="delete-form">
    @method('delete')
    @csrf
